...
1. 如果有老版本的ja-netfilter，请将老版本的删除，下载最新版[ja-netfilter](https://gitee.com/ja-netfilter/ja-netfilter/releases)
...
6. 找到idea.vmoptions文件添加（该文件不在ja-netfilter中，在idea安装目录下自己找一下），**注意下面的xxx需要换成自己的路径**
